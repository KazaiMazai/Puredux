...
public extension AnyStore {
     ...
     */
    func map<T>(_ keyPath: @Sendable @autoclosure @escaping () -> KeyPath<State, T>) -> AnyStore<T, Action> {
    ...
    */
    func flatMap<T>(_ keyPath: @Sendable @autoclosure @escaping () -> KeyPath<State, T?>) -> AnyStore<T?, Action> {
